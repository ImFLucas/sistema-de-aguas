...
import { colunasPesquisa_2 } from "../../requests/Constants";
...
const Pesquisa2 = () => {
  ...
  const getTabela = async (inp) => {
    ...
    const temp = await fetch("http://localhost:1000/pesquisa-2", options);
  ...
  return (
    <div className="Caixa">
      ...
      <div className="TableField">
        <Table linhas={tab} colunas={colunasPesquisa_2} />
      </div>
    </div>
  );
};
