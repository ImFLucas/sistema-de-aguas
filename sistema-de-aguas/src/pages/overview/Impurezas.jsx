...
import { selectFromLinhas, colunasImpureza } from "../../requests/Constants";
...
const Impurezas = () => {
  ...
  selectFromLinhas.from = "impureza";
    ...
    <div className="Caixa">
      ...
      <nav className="NavOverview">
        ...
        <nav className="NavOps">
          <Link to="/impurezas/inserir" className="NavOpsLink"><h3><FiPlusCircle/> INSERIR</h3></Link>
          <Link to="/impurezas/remover" className="NavOpsLink"><h3><FiXCircle/> REMOVER</h3></Link>
          <Link to="/impurezas/atualizar" className="NavOpsLink"><h3><FiRefreshCw/> ATUALIZAR</h3></Link>
        </nav>
      </div>

      <div className="TableField">
        <Table linhas={tab} colunas={colunasImpureza} />
      </div>
    </div>
  );
};

export default Impurezas;
