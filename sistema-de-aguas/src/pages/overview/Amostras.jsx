...
import { selectFromLinhas, colunasAmostra } from "../../requests/Constants";
    ...
    <div className="Caixa">
      ...
      <nav className="NavOverview">
        ...
        <nav className="NavOps">
          <Link to="/amostras/inserir" className="NavOpsLink"><h3><FiPlusCircle/> INSERIR</h3></Link>
          <Link to="/amostras/remover" className="NavOpsLink"><h3><FiXCircle/> REMOVER</h3></Link>
          <Link to="/amostras/atualizar" className="NavOpsLink"><h3><FiRefreshCw/> ATUALIZAR</h3></Link>
        </nav>
      </div>

      <div className="TableField">
        <Table linhas={tab} colunas={colunasAmostra} />
      </div>
    </div>
  );
};
