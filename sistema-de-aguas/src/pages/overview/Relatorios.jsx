...
import { selectFromLinhas, colunasRelatorio } from "../../requests/Constants";
...
const Relatorios = () => {
  ...
  selectFromLinhas.from = "relatorio";
    ...
    <div className="Caixa">
      <div className="Field">
        ...
        <nav className="NavOps">
          <Link to="/relatorios/inserir" className="NavOpsLink"><h3><FiPlusCircle/> INSERIR</h3></Link>
          <Link to="/relatorios/remover" className="NavOpsLink"><h3><FiXCircle/> REMOVER</h3></Link>
          <Link to="/relatorios/atualizar" className="NavOpsLink"><h3><FiRefreshCw/> ATUALIZAR</h3></Link>
        </nav>
      </div>

      <div className="TableField">
        <Table linhas={tab} colunas={colunasRelatorio} />
      </div>
    </div>
  );
};
