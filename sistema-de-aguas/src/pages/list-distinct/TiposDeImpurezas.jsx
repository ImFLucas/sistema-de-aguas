...
const TiposDeImpurezas = () => {
  const [tab, setTab] = useState([]);

  const selectDistinctFrom = { selectDistinct: "tipo", from: "impureza" };
  const colunas = [{ heading: "Tipos de impurezas", value: "tipo" }];
...
export default TiposDeImpurezas;
